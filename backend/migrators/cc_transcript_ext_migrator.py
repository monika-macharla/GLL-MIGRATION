...
class CCTranscriptExtMigrator(BaseMigrator):
    ...
    def migrate(self) -> int:
        ...
        logger.info(
            "Starting CC Transcript Extended Info Import Migration..."
        )
        ...
        while True:
            ...
            query = (
                select(
                    ...
                    source_table.c.texas_core_completion_status,
                    source_table.c.pos_conferred_credential,
                    source_table.c.institution_notes,
            ...
            for row in rows:
                ...
                mapped_row = {
                    ...
                    "core_complete": None,
                    "trc_fresh_start": None,
                    "tsi_met": None,
                    "core_curriculum": None,
                    "tec_drops": None,
                    "term_comments": None,
                    "term_disciplinary": None,
                    "terms_crses_coms": None,
                    "terms_crses_oth_desc": None,
                    "terms_crses_othdts": None,
                    "terms_crses_wthdrw": None,
                    "term_stands": None,
                    "trc_lines": None,
                    "texas_core_completion_status": self._truncate(
                        row_dict.get(
                            source_table.c.texas_core_completion_status
                        ),
                        255
                    ),
                    "pos_conferred_credential": self._truncate(
                        row_dict.get(
                            source_table.c.pos_conferred_credential
                        ),
                        255
                    ),
                    "academic_notes": row_dict.get(
                        source_table.c.institution_notes
                    ),
        ...
        logger.info(
            "CC Transcript Extended Info Import Summary: "
    ...
    def _load_destination_institution_lookup(self):
        ...
        logger.info(
            "Loaded CCTranscriptExt destination institution lookup: "
            f"{len(lookup)} names"
        )
